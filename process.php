<?php
    ...
    function pendaftaranSiswa($data)
    {
        ...
        if ($surat_pernyataan_tipe && $ijazah_tipe == 'application/pdf') {
            ...
            $url = 'https://objectstorage.ap-tokyo-1.oraclecloud.com/p/7LKEyCuML619va_8Fuv-u23M0NX09k388iDs8foKqtDOxVt1BIztWWG6_YwVZ28f/n/nryojlw3k71c/b/bucket-uts/o/';

            // Memindahkan file yang diupload
            define ('SITE_ROOT', realpath(dirname(__FILE__)));
            move_uploaded_file($pas_foto_tmp, SITE_ROOT . "$url/$pas_foto_baru");
            move_uploaded_file($surat_pernyataan_tmp, SITE_ROOT . "$url/$surat_pernyataan_baru");
            move_uploaded_file($ijazah_tmp, SITE_ROOT . "$url/$ijazah_baru");
